...
DATA_FILES = [
	('/opt/extras.ubuntu.com/youtube-indicator/bin',glob.glob('bin/*')),
	('/opt/extras.ubuntu.com/youtube-indicator/share/youtube-indicator',['debian/changelog']),
	('/opt/extras.ubuntu.com/youtube-indicator/share/youtube-indicator',glob.glob('src/*.py')),
	('/opt/extras.ubuntu.com/youtube-indicator/share/youtube-indicator',['data/youtube-indicator-autostart.desktop']),	
	('/opt/extras.ubuntu.com/youtube-indicator/share/youtube-indicator/icons',glob.glob('data/icons/*.svg')),
	('/opt/extras.ubuntu.com/youtube-indicator/share/youtube-indicator/social',glob.glob('data/social/*.svg')),
	('/usr/share/applications',['data/extras-youtube-indicator.desktop']),
	]
...
class install_data(_install_data):
	def run(self):
		for lang in os.listdir('build/locale-langpack/'):
			lang_dir = os.path.join('/opt/extras.ubuntu.com/youtube-indicator/share', 'locale-langpack', lang, 'LC_MESSAGES')
